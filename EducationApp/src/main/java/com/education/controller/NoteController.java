...
public class NoteController {
	...
	public ResponseEntity<?> getNotesByItemCode(@RequestParam("itemCode") String itemCode) 
	{
	...
	public ResponseEntity<InputStreamResource> getNotesById(@PathVariable("noteId") Long noteId) 
	{
