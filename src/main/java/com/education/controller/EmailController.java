...
public class EmailController {
	...
	public ResponseEntity<Object> verifyOtp(@RequestBody VerifyEmailOtpDTO verifyEmailDTO)
	{
	...
	public ResponseEntity<Object> resetToPassword(@RequestBody ResetPasswordDTO resetPasswordDTO) {
