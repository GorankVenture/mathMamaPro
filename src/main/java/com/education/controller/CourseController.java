...
public class CourseController {
	...
	{
		//boolean isPaid=transactionService.checkTransactionPaid(transactionId);
		//if(isPaid)
		//{
	...
	public ResponseEntity<Object> getCourseDetails(@RequestParam ("courseCode") String courseCode)
	{
	...
	@GetMapping(value="/getPaymentofAllCourses")
	public ResponseEntity<Object> getPaymentofAllCourses(@RequestParam ("courseId") Long courseId, @RequestParam ("email") String email)
	{
		Transaction transactionResponse=transactionService.getCourseIdAndEmail(courseId, email);
		 if(transactionResponse!=null)
		    {
		     return  Response2.generateResponse("Courses list are get displayed according after the transaction get successful",HttpStatus.OK,"200");
		    }
		    else
		    {
		      return Response2.generateResponse("No courses list  are displayed and transaction remains pending", HttpStatus.BAD_REQUEST, "400");
		    }
	}
